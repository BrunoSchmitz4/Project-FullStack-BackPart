...
using PokeAPIWeb.Application.Mapping;
using PokeAPIWeb.Application.Swagger;
using PokeAPIWeb.Domain.Models.PokemonAggregate;
using PokeAPIWeb.Infraestrutura.Repositories;
...
var key = Encoding.ASCII.GetBytes(PokeAPIWeb.Key.Secret);
